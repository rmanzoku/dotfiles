...
- Run `python3 scripts/privacy_scan.py <path> --mode trusted-local` and report warnings.
...
- Run `python3 scripts/privacy_scan.py --mode shareable`; failure blocks delivery.
...
- Run `python3 scripts/privacy_scan.py --mode teacher-pack`; failure blocks delivery.
