...
def main() -> int:
    ...
    if "timeout" in failure_reasons:
        ...
        recommended = "Run succeeded with non-fatal Codex CLI warnings; inspect nonfatal_reasons and run.err if task quality is suspicious."
